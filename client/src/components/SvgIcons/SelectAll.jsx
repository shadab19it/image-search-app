...
const SelectAll = ({ isSelectAll = false }) => {
  return (
    <svg width='25px' height='25px' className='select-svg-icon' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <g id='Interface / Checkbox_Check'>
        <path
          ...
          stroke={`${isSelectAll ? "#5465ff" : "gray"}`}
          strokeWidth='2'
          strokeLinecap='round'
